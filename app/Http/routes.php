...
Route::get('/api/project/download/{hash}/{ext?}', 'ProjectController@downloadProject')->where('hash', '[0-9a-zA-Z]{6}');
...
Route::any('/api/projects/user', 'ProjectController@getProjects');
