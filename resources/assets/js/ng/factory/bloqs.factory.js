...
(function(bloqsLanguages) {
	var texts = {
		"zh": {
			...
			"bloq-numberArray-advanced-float": "浮点型",
			"bloq-numberArray-advanced-int": "整型",
			"bloq-map-map": "映射",
			"bloq-map-value": "value between [0-",
			"bloq-map-advanced-map": "映射",
			...
			"bloq-declare-variable-declare-type-int": "整型",
			"bloq-declare-variable-declare-type-float": "浮点型",
			...
			"bloq-num-conversion-int": "整型",
			"bloq-num-conversion-float": "浮点型"
		}
	};
